...
<template>
    <coin-desk-main-wrapper :with-space="false">
        <div class="widget-container">
            <MiniChart :options="{ colorTheme: 'dark', height: 420, symbol: 'FX:EURUSD', largeChartUrl: route('trade.trading'), }" />
            <TechnicalAnalysis :options="{ colorTheme: 'dark', height: 420, symbol: 'FX:EURUSD', largeChartUrl: route('trade.trading'), }" />
            <SingleTicker :options="{ colorTheme: 'dark',height: 420, symbol: 'FX:EURUSD', largeChartUrl: route('trade.trading'), }" />
