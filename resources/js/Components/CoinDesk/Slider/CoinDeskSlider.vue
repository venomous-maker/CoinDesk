                    ...
                    >
                        <ul>
                            ...
                            <li
                                ...
                                :data-thumb="
                                    getImportedAsset(
                                        'images/main-slider/slider2/slide1.jpg',
                                    )
                                "
                                data-rotate="0"
                            ...
                            >
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/earth.png',
                                            )
                                        "
                                        alt=""
                                        class="spin-city"
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/bitcoin.png',
                                            )
                                        "
                                        alt=""
                                    />
                            ...
                            >
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/earth2.png',
                                            )
                                        "
                                        alt=""
                                        class="spin-city"
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/earth2-shadow.png',
                                            )
                                        "
                                        alt=""
                                    />
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/rocket.png',
                                            )
                                        "
                                        alt=""
                                        class="floating"
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/fire.gif',
                                            )
                                        "
                                        alt=""
                                        class="floating"
                                ...
                                >
                                    <div
                                        class="coin-slide bg-full-width coin-slide-rotate bg-repeat-y"
                                        :style="{
                                            backgroundImage:
                                                'url(' +
                                                getImportedAsset(
                                                    'images/main-slider/slider2/coin-sky.png',
                                                ) +
                                                ')',
                                            height: '100vh',
                                        }"
                            ...
                            >
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/rock.png',
                                            )
                                        "
                                        alt=""
                                    />
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/agent.png',
                                            )
                                        "
                                        alt=""
                                    />
                                ...
                                >
                                    <img
                                        :src="
                                            getImportedAsset(
                                                'images/main-slider/slider2/plant.png',
                                            )
                                        "
                                        alt=""
                                    />
