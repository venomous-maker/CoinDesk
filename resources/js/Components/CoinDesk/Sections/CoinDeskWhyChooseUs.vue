            ...
            <div class="section-content">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 m-b30 animate_line">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            <div class="icon-lg site-text-primary m-b20">
                                <a href="#" class="icon-cell"><img :src='getImportedAsset("images/icon/pick-29.png")' alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 m-b30 animate_line">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            <div class="icon-lg site-text-primary m-b20">
                                <a href="#" class="icon-cell"><img :src='getImportedAsset("images/icon/pick-28.png")' alt=""></a>
                            </div>
                            <div class="icon-content ">
                    ...
                    <div class="col-lg-4 col-md-6 m-b30 animate_line">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            <div class="icon-lg site-text-primary m-b20">
                                <a href="#" class="icon-cell"><img :src='getImportedAsset("images/icon/pick-17.png")' alt=""></a>
                            </div>
                            <div class="icon-content">
                    ...
                    <div class="col-lg-4 col-md-6 m-b30 animate_line">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            <div class="icon-lg site-text-primary m-b20">
                                <a href="#" class="icon-cell"><img :src='getImportedAsset("images/icon/pick-19.png")' alt=""></a>
                            </div>
                            <div class="icon-content">
                    ...
                    <div class="col-lg-4 col-md-6 m-b30 animate_line">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            <div class="icon-lg site-text-primary m-b20">
                                <a href="#" class="icon-cell"><img :src='getImportedAsset("images/icon/pick-12.png")' alt=""></a>
                            </div>
                            <div class="icon-content">
                    ...
                    <div class="col-lg-4 col-md-6 m-b30 animate_line">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            <div class="icon-lg site-text-primary m-b20">
                                <a href="#" class="icon-cell"><img :src='getImportedAsset("images/icon/pick-38.png")' alt=""></a>
                            </div>
                            <div class="icon-content">
